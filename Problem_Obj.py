    ...
    def __init__(self):
        ...
        if self.operator == 0:
            ...
            while self.second_val == 0: # Cannot divide by 0, generate a new random number.
                self.second_val = random.randrange(1,9)
            self.answer = self.first_val / self.second_val
        ...
        # Since we may be changing what the second value is so that we do not divide by zero it is necessary to assign the value for the question here.
